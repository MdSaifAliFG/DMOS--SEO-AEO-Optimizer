  ...
  return (
    <div className="space-y-6">
      {isScanInFlight ? (
        ...
        <div className="space-y-6">
          <Card className="p-6 border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0f172a] shadow-xs space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 dark:border-slate-800 pb-4">
              <div className="space-y-1 min-w-0">
                ...
                <div className="text-sm font-mono text-slate-900 dark:text-white font-semibold truncate">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 font-mono">
            <div className="p-4 rounded-xl bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 shadow-xs">
              <span className="text-[11px] font-semibold uppercase text-slate-500 dark:text-slate-400 font-sans">
                Pages Discovered
              </span>
            ...
            <div className="p-4 rounded-xl bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 shadow-xs">
              ...
              <div
                className={`text-2xl font-bold mt-1 ${
                  activeScan.pages_failed > 0 ? "text-rose-600 dark:text-rose-400" : "text-slate-700 dark:text-slate-300"
                }`}
              >
