        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 sm:p-5 rounded-2xl bg-white dark:bg-[#0f172a] border border-slate-200/80 dark:border-slate-800 shadow-xs">
          <div className="space-y-1">
            <div className="flex items-center gap-2.5 flex-wrap">
              ...
              <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-slate-900 dark:text-white">SEO Projects ({total})</h1>
                    ...
                    >
                      <td className="py-3.5 px-4">
                        <Link
                          ...
                          className="font-semibold text-slate-900 dark:text-white hover:text-blue-600 dark:hover:text-blue-400 truncate block text-sm"
                        >
                          {proj.name}
                        </Link>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/60 backdrop-blur-xs animate-in fade-in">
            ...
            >
              <div className="flex items-center justify-between pb-3 border-b border-slate-100 dark:border-slate-800">
                <div>
                  <h3 className="text-base font-bold text-slate-900 dark:text-white">Add New SEO Project</h3>
              ...
              <form onSubmit={handleCreateProject} className="space-y-4">
                ...
                <div className="space-y-1">
                  <label className="text-xs font-semibold text-slate-700 dark:text-slate-300">Website URL / Domain *</label>
                  <input
                    type="text"
                    required
                ...
                <div className="pt-2">
                  ...
                  {showAdvanced && (
                    <div className="mt-3 p-3.5 bg-slate-50 dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800 rounded-xl space-y-3 animate-in fade-in">
                      {/* Crawl Limit */}
                      <div className="space-y-1">
                        ...
                        <select
                          ...
                          className="w-full px-2.5 py-1.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-xs text-slate-900 dark:text-white focus:outline-none focus:border-blue-500 cursor-pointer"
                        >
                          <option value={10} className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">10 Pages (Quick Test)</option>
                          <option value={50} className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">50 Pages</option>
                          <option value={100} className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">100 Pages (Standard Default)</option>
                          <option value={250} className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">250 Pages</option>
                          <option value={500} className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">500 Pages</option>
                          <option value={1000} className="bg-white dark:bg-slate-800 text-slate-900 dark:text-white">1,000 Pages (Enterprise)</option>
                        </select>
                      </div>
