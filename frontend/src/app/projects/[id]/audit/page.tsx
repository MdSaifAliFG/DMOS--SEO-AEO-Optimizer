  ...
  return (
    <DashboardShell>
      <div className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-slate-900 dark:text-white flex items-center gap-2.5">
                ...
                <span className="text-xs px-2.5 py-0.5 rounded-full font-mono font-medium bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800/60">
                  Phase 2 Engine
                </span>
              </h1>
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                Target: <span className="font-mono text-slate-800 dark:text-slate-200 font-semibold">{project.domain}</span>
              </p>
            </div>
          </div>
        ...
        {/* Empty State */}
        {!activeScan ? (
          <Card className="p-12 text-center border-dashed border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0f172a] shadow-xs">
            <Activity className="w-12 h-12 text-slate-400 dark:text-slate-500 mx-auto mb-4" />
            <h3 className="text-lg font-bold text-slate-900 dark:text-white">No Audits Executed Yet</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
              <Card className="p-6 border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0f172a] space-y-6 shadow-xs">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-100 dark:border-slate-800 pb-4">
                  <div className="space-y-1 min-w-0">
                    ...
                    <div className="text-sm font-mono text-slate-900 dark:text-white truncate" title={activeScan.target_url}>
                  ...
                  <div className="flex items-center gap-4 text-xs text-slate-500 dark:text-slate-400 shrink-0">
                    <div className="flex flex-col items-start sm:items-end">
                      <span className="text-[10px] uppercase font-bold text-slate-400 dark:text-slate-500">Initiated</span>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div className="p-4 rounded-xl bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 shadow-xs">
                  <span className="text-[11px] font-semibold uppercase text-slate-500 dark:text-slate-400">Pages Discovered</span>
                  <div className="text-2xl font-bold text-slate-900 dark:text-white font-mono mt-1">
                    {activeScan.pages_discovered}
                  </div>
                </div>
                <div className="p-4 rounded-xl bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 shadow-xs">
                  <span className="text-[11px] font-semibold uppercase text-slate-500 dark:text-slate-400">Pages Crawled</span>
                  <div className="text-2xl font-bold text-emerald-600 dark:text-emerald-400 font-mono mt-1">
                    {activeScan.pages_crawled}
                  </div>
                </div>
                <div className="p-4 rounded-xl bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 shadow-xs">
                  <span className="text-[11px] font-semibold uppercase text-slate-500 dark:text-slate-400">Failed / Errors</span>
                  <div className={`text-2xl font-bold font-mono mt-1 ${activeScan.pages_failed > 0 ? "text-rose-600 dark:text-rose-400" : "text-slate-700 dark:text-slate-300"}`}>
                    {activeScan.pages_failed}
                  </div>
                </div>
                <div className="p-4 rounded-xl bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 shadow-xs">
                  <span className="text-[11px] font-semibold uppercase text-slate-500 dark:text-slate-400">Issues Found</span>
                  ...
                  return (
                    <div
                      ...
                      className={`p-3.5 rounded-xl border cursor-pointer transition-all ${
                        isSelected
                          ? "bg-blue-50/80 dark:bg-blue-950/40 border-blue-300 dark:border-blue-700 ring-1 ring-blue-400/60 shadow-xs"
                          : "bg-white dark:bg-[#0f172a] border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 hover:bg-slate-50/80 dark:hover:bg-slate-800/40 shadow-2xs"
                      }`}
                    >
                      <div className="flex items-center justify-between gap-2 mb-1.5">
                        <ScanStatusBadge status={s.status} size="sm" />
                        <span className="text-[10px] font-mono text-slate-500 dark:text-slate-400">{s.progress}%</span>
                      </div>
                      <div className="text-xs font-semibold text-slate-800 dark:text-slate-200 truncate">{s.target_url}</div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-px">
                ...
                <div className="text-xs text-slate-500 dark:text-slate-400 hidden sm:block">
                  Crawl Date: <span className="text-slate-800 dark:text-slate-200 font-semibold">{formatDate(activeScan.created_at)}</span>
                </div>
              </div>
              ...
              {activeTab === "telemetry" && (
                <div className="space-y-6">
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="p-4 rounded-xl bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 shadow-xs">
                      <span className="text-xs text-slate-500 dark:text-slate-400 font-semibold uppercase">robots.txt Status</span>
                      <div className="text-sm font-mono text-slate-800 dark:text-slate-200 mt-2 font-medium">
                    ...
                    <div className="p-4 rounded-xl bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 shadow-xs">
                      <span className="text-xs text-slate-500 dark:text-slate-400 font-semibold uppercase">XML Sitemap</span>
                      <div className="text-sm font-mono text-slate-800 dark:text-slate-200 mt-2 font-medium">
                    ...
                    <div className="p-4 rounded-xl bg-white dark:bg-[#0f172a] border border-slate-200 dark:border-slate-800 shadow-xs">
                      <span className="text-xs text-slate-500 dark:text-slate-400 font-semibold uppercase">Crawl Duration</span>
                      <div className="text-sm font-mono text-slate-800 dark:text-slate-200 mt-2 font-medium">
