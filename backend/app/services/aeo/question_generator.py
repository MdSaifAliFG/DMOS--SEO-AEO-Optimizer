...
class QuestionGeneratorEngine:
    ...
    TEMPLATES = {
        "Brand Overview": [
            ...
            ("What makes {brand} unique in the {industry} market?", AeoIntent.INFORMATIONAL),
            ("Overview of {brand} services and company background", AeoIntent.INFORMATIONAL),
        ],
        "Product Capabilities": [
            ...
            ("Step-by-step guide to achieving results with {brand}", AeoIntent.TRANSACTIONAL),
            ("Does {brand} support real-time data and automated reporting?", AeoIntent.INFORMATIONAL),
            ("What are the primary use cases of {brand} for {audience}?", AeoIntent.COMMERCIAL),
        ],
        "Competitor Comparison": [
            ...
            ("Why choose {brand} over {competitor} in 2026?", AeoIntent.COMPARISON),
            ("Feature breakdown: {brand} compared to {competitor}", AeoIntent.COMPARISON),
            ("Migrating from {competitor} to {brand}: pros and cons", AeoIntent.COMPARISON),
        ],
        "Pricing & Commercial": [
            ...
            ("Does {brand} offer a free tier or trial for {audience}?", AeoIntent.COMMERCIAL),
            ("Pricing plans and ROI comparison for {brand}", AeoIntent.COMMERCIAL),
            ("Cost analysis: {brand} for {audience}", AeoIntent.COMMERCIAL),
        ],
        "Integration & Technical": [
            ...
            ("API documentation and developer resources for {brand}", AeoIntent.INFORMATIONAL),
            ("How does {brand} ensure enterprise data privacy?", AeoIntent.INFORMATIONAL),
        ],
        "Problem & Solution": [
            ...
            ("Common mistakes in {industry} and how {brand} helps avoid them", AeoIntent.INFORMATIONAL),
            ("How {audience} can scale operations using {brand}", AeoIntent.INFORMATIONAL),
        ],
        "Industry Best Practices": [
            ...
            ("Future trends in {industry} and how {brand} addresses them", AeoIntent.INFORMATIONAL),
            ("Essential checklist for {industry} success in 2026", AeoIntent.INFORMATIONAL),
        ],
        "Alternatives & Reviews": [
            ("Top alternatives to {brand} in 2026", AeoIntent.COMMERCIAL),
            ("{brand} reviews and user ratings", AeoIntent.COMMERCIAL),
            ("What do customer reviews say about {brand}?", AeoIntent.COMMERCIAL),
            ("Pros and cons of using {brand} for {audience}", AeoIntent.COMMERCIAL),
        ],
    }
